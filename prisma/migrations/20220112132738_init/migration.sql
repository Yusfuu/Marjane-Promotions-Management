...
-- AddForeignKey
ALTER TABLE `Center` ADD CONSTRAINT `Center_subadminId_fkey` FOREIGN KEY (`subadminId`) REFERENCES `Subadmin`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
